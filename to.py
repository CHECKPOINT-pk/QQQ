...
# AUTHOR : ETHAN KLEIN HUILEN (MR-ERROR-708)
...
╚═╝  ╚═╝ ╚═════╝    ╚═╝    ╚═════╝      ╚═════╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{style} AUTHOR  : ETHAN KLEIN HUILEN
{style} GITHUB  : MR-ERROR-708
...
class HighestUpdate:
    ...
    def menu(self):
        ...
        print(f"{white}[1] Start Auto Creation (Best Speed)")
        print(f"[0] Exit")
    ...
    def start(self):
        ...
        print(f"{green}Targeting FB Graph API v19.0...")
        print(f"{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        ...
        print(f"{white}Results saved in /sdcard/MR-ERROR-OK.txt")
    ...
    def create(self):
        ...
        try:
            ...
            if 'c_user' in ses.cookies.get_dict():
                ...
                print(f"\r{green}[OK] {uid} | {password}      ")
                self.oks.append(uid)
                with open("/sdcard/MR-ERROR-OK.txt", "a") as f:
                    f.write(f"{uid}|{password}\n")
            elif 'checkpoint' in response.url:
                self.cps.append(email)
            
            self.loop += 1
            print(f"\r{white}[CREATING] {self.loop} | OK:{len(self.oks)} CP:{len(self.cps)}", end="")
