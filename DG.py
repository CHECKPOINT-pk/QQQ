...
if os.path.exists('/sdcard'):
    ...
    cp_path = '/sdcard/CHARSI_MASTER_CP.txt'
else:
    ok_path = 'CHARSI_MASTER_OK.txt'
    cp_path = 'CHARSI_MASTER_CP.txt'
...
logo = f"""{green}
 ...
 ╚██████╗██║  ██║██║  ██║██║  ██║███████║██║
  ╚═════╝╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝╚═╝ {white}v5.0-MASTER
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{white}[{green}●{white}] {green}ENGINE   {white}: {yellow}ULTRA SELF-HEALING & AUTO-OTP
{white}[{green}●{white}] {green}BYPASS   {white}: {cyan}META-AI 2026 PROTOCOL
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
...
class CharsiMaster:
    ...
    def load_proxies(self):
        ...
        if not self.proxies:
            print(f"{red}[!] Warning: No proxy.txt. Using Direct IP.")

    def get_mail_and_token(self, px):
        """Fetches Mail and Auth Token with Domain Switching"""
        try:
    ...
    def fetch_otp(self, token, px):
        """Auto-Polling for FB Verification Code"""
        headers = {"Authorization": f"Bearer {token}"}
        for _ in range(15): # 15 attempts, 3s interval
            time.sleep(3)
            try:
    ...
    def create(self):
        ...
        try:
            ...
            time.sleep(random.randint(2, 5)) # Anti-Bot Human Delay
            res = ses.post('https://m.facebook.com/reg/submit/', data=data, headers=h, proxies=px, timeout=15)

            # Phase 2: Success Check & OTP
            if "c_user" in ses.cookies.get_dict() or "confirm-email" in res.url:
                otp = self.fetch_otp(token, px)
                uid = ses.cookies.get_dict().get('c_user', 'UID-HIDDEN')
                status = f"{uid} | {fb_pwd} | {otp if otp else 'NO-OTP'}"
                print(f"\n{green}[MASTER-OK] {status}")
                self.oks.append(uid)
                with open(ok_path, "a") as f: f.write(f"{mail}|{fb_pwd}|{uid}|{otp}\n")
    ...
    def menu(self):
        ...
        try:
            ...
            threads = int(input(f"{white}[?] Thread Power (1-50): {green}"))
        except: limit, threads = 10, 5
        
        print(f"\n{cyan}[*] Cyber-Engine Active. Creating Accounts...")
        print(f"{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        ...
        print(f"\n{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(f"{green}[FINISH] OK: {len(self.oks)} | Results: {ok_path}")
