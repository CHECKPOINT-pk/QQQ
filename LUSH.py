# HIGH PERFORMANCE AUTO CREATE FB (SG/ID MIX)
# AUTHOR : CHARSI BRAND
# VERSION: ASIA REAL MODE 2026
...
logo = f"""{green}
 ...
 / __| || | /_\ | _ \/ __|_ _|
| (__| __ |/ _ \|   /\__ \| | 
 \___|_||_/_/ \_\_|_\|___/___| {white}ASIA
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
{style} {green}AUTHOR   {white}: {yellow}CHARSI BRAND
{style} {green}TARGET   {white}: {cyan}INDONESIA (ID) & SINGAPORE (SG)
{style} {green}DISPLAY  {white}: {green}LIVE DATA (NAME/DOB/MAIL)
{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"""
...
class CharsiAsia:
    def __init__(self):
        ...
        self.loop = 0
        self.proxies = []
        # Configuring Faker for ID and SG only
        self.fk = Faker(['id_ID', 'en_SG']) 
        self.ua = UserAgent()
        self.base_api = "https://api.mail.tm"

    def load_proxies(self):
        """Loads proxies if available"""
        try:
            if os.path.exists("proxy.txt"):
                with open("proxy.txt", 'r') as f:
                    self.proxies = [line.strip() for line in f if line.strip()]
                print(f"{style} {green}Proxy Connected: {len(self.proxies)} (Recommended: SG/ID Proxies){reset}")
            else:
                print(f"{style} {red}No proxy.txt found - Running on default IP{reset}")
            time.sleep(2)
        except: pass
    ...
    def get_mail_tm(self, proxy_dict):
        try:
            ...
            # Making email look like a real name
    ...
    def create(self):
        ...
        # Real Date of Birth Generation
        day = str(random.randint(1, 28))
        month = str(random.randint(1, 12))
        year = str(random.randint(1995, 2004))
        ...
        try:
            ...
            head = {
                ...
                'accept-language': 'id-ID,id;q=0.9,en-SG;q=0.8,en-US;q=0.7', # Requesting ID/SG Content
            ...
            data.update({
                ...
                'birthday_year': year,
                'sex': '2' if random.random() > 0.3 else '1' # Mixed Gender
            })
    ...
    def menu(self):
        ...
        print(f"{white}[{green}1{white}] {green}START ASIA MIX MAKER (SG/ID)")
    ...
    def start(self):
        ...
        print(f"{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        print(f"{yellow}NOTE: Put SG/ID Proxies in proxy.txt for best results!{white}")
        print(f"{white}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
        with ThreadPool(max_workers=15) as pool: # Lower threads for better quality
